...
NOTIFICATION_ENQUEUE_BATCH_SIZE = 100
NOTIFICATION_REDIS_URL = os.getenv("NOTIFICATION_REDIS_URL", CELERY_BROKER_URL)
NOTIFICATION_STATE_REPORT_STREAM = "notification-state-reports"
NOTIFICATION_STATE_REPORT_GROUP = "notification-state-report-workers"
NOTIFICATION_STATE_REPORT_CONSUMER = "state-report-worker"
NOTIFICATION_STATE_REPORT_BATCH_SIZE = 1000
NOTIFICATION_STATE_REPORT_MAX_WAIT_SECONDS = 3
